...
export const metadata = {
	...
	title: 'Zamokchi | Ekipaj group',
	description:
		'Zamokchi - Вскрываем замки любой сложности без каких-либо повреждений! Окажу услуги замена замка, ремонт, установка, замена личинок, аварийное открытие. Быстро, качественно. Электронный программируемый замок',
